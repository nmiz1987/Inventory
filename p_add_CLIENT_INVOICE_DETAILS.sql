...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Procedure P_ADD_CLIENT_INVOICE_DETAILS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "HR"."P_ADD_CLIENT_INVOICE_DETAILS" (
...
BEGIN
    ...
    INSERT INTO P_CLIENT_INVOICE_DETAILS (invoice_number, line_number, item_id, quantity)
            VALUES (c_invoice, c_line_number, c_item_id, c_qty_number);
...
END p_add_CLIENT_INVOICE_DETAILS;
